...
public class ShopCartActivity extends BaseActivity {
    ...
    protected void init() {
        ...
        mAdapter = new CommonAdapter<ShopCarListBean>(this, mShopCarList, R.layout.item_shop_car) {
            ...
            public void convert(ViewHolder helper, final int position, ShopCarListBean item) {
                ...
                if (split.length > 0) {
                    helper.setImageByUrl(R.id.iv_goods_pic, split[0], ShopCartActivity.this);
                }
        ...
        mXlvUtils = new LoadErrorUtils(mLvShopCar, this, new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                loadData();
            }
