...
public class ShopNameEditActivity extends BaseActivity {
    ...
    @Override
    protected void init() {
        mTitle.setText(getResources().getText(R.string.shop_name));
        mTvRight.setText(getResources().getText(R.string.complete));
        mTvBack.setVisibility(View.VISIBLE);
        mTvRight.setVisibility(View.VISIBLE);
        mIvMore.setVisibility(View.GONE);
        Bundle bundle = this.getIntent().getExtras();
        mNickName.setText(bundle.getString("shopname"));
        mNickName.setHint(getResources().getString(R.string.shop_name));
    ...
    void changeShopName(Map<String, String> changeMap) {
                ...
                .subscribe(new ApiSubscriberCallBack<BusinessInfoBean>() {
                    ...
                    public void onSuccess(BusinessInfoBean businessInfoBean) {
                        if (businessInfoBean.getStatus() == 0) {
                            MyApplication.shopInfo.setBusinessName(mNickName.getText().toString().trim());
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.tv_right:
                ...
                changeMap.put("businessName", mNickName.getText().toString().trim());
                changeMap.put("changeStatus", "1");
                changeShopName(changeMap);
                break;
        }
    }
